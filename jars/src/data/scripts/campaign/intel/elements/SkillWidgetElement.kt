...
class SkillWidgetElement(var id: String, var activated: Boolean, var canChangeState: Boolean, var iconPath: String, var color: Color, tooltip: TooltipMakerAPI, width: Float, height: Float) : LunaElement(tooltip, width, height) {

    var sprite = Global.getSettings().getSprite(iconPath)
    var inactiveBorder = Global.getSettings().getSprite("graphics/icons/skills/sotf_skillBorderInactive.png")
    var activeBorder = Global.getSettings().getSprite("graphics/icons/skills/sotf_skillBorderActive.png")
