 ...
 * @author Nicke535
 */
public class SotfChaliceBoltGuidanceScript extends BaseEveryFrameCombatPlugin {
     ...
     */
    public SotfChaliceBoltGuidanceScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
        this.proj = proj;
        this.target = target;
