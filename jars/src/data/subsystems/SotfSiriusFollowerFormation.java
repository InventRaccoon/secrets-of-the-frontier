...
/**
 *  basic MagicLib circle formation but rewritten in Java so I can tweak the rotational speed
 */

public class SotfSiriusFollowerFormation extends DroneFormation {
    ...
    public void advance(ShipAPI ship, Map<ShipAPI, ? extends PIDController> drones, float amount) {
        ...
        for (Map.Entry<ShipAPI, ? extends PIDController> entry : drones.entrySet()) {
            ...
            Vector2f point = MathUtils.getPointOnCircumference(shipLoc, ship.getCollisionRadius() * 2.5f + 40f, angle);
